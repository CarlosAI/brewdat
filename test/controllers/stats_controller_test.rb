...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference("Stat.count") do
      post stats_url, params: { stat: { createdby: @stat.createdby, nombre: @stat.nombre, tabla: @stat.tabla } }
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { createdby: @stat.createdby, nombre: @stat.nombre, tabla: @stat.tabla } }
